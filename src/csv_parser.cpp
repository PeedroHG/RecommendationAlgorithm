...
// --- NOVA INCLUSÃO PARA OTIMIZAÇÃO DE ALTA PERFORMANCE (mmap) ---
// Headers necessários para memory-mapped I/O em sistemas baseados em Linux/macOS.
// Esta técnica é significativamente mais rápida para leitura de arquivos grandes.
#include <fcntl.h>
#include <sys/mman.h>
#include <sys/stat.h>
#include <unistd.h>
#include <string.h>     // Para memchr, uma busca de caractere otimizada
...
void countEntityRatings(const UserRatingsLog& users_ratings_log,
    ...
    // --- OTIMIZAÇÃO DE PARALELISMO: Contagem Lock-Free ---
