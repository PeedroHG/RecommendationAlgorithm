...
const int K_NEIGHBORS =5; // K for final recommendation list from candidates
const size_t NUM_RANDOM_USERS_TO_EXPLORE = 100;
...
// cd Parameters
const int NUM_LSH_TABLES = 8;        // Number of hash tables (L)
const int NUM_HYPERPLANES_PER_TABLE = 10; // Number of bits in each hash (k)
